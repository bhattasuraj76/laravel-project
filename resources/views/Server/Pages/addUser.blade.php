                        ...
                        <div class="x_panel">
                            <div class="x_title">
                                <h2><a href="" class="btn btn-primary "> @yield('title',$title)</a>
                                    <a href="{{route('users')}}" class="btn btn-success"><i class="fa fa-users"></i>&ensp;View User</a>
                                </h2>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="username" name="username"
                                                   class="form-control col-md-7 col-xs-12" value="{{old('username')}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class=" form-control col-md-7 col-xs-12" type="file" id="profile-img"
                                                   name="upload" value="{{old('upload')}}">
                                            <small class="text text-danger">{{$errors->first('upload')}}</small>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="pas" class="control-label col-md-3 col-sm-3 col-xs-12">Password
                                            *</label>

                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="pas" class="form-control col-md-7 col-xs-12" type="password"
                                                   name="password">
                                            <small class="text text-danger">{{$errors->first('password')}}</small>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="cpass" class="control-label col-md-3 col-sm-3 col-xs-12">Confirm
                                            Password
                                            *</label>

                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="cpass" class="form-control col-md-7 col-xs-12" type="password"
                            ...
                            <div class="col-md-4">
                                <img src="{{url('public/icons/notfound.jpg')}}?>" id="profile-img-tag" alt=""
