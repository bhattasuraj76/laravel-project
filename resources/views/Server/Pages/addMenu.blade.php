                        ...
                        <div class="x_panel">
                            <div class="x_title">
                                <h2><a href="" class="btn btn-primary "> @yield('title',$title)</a>
                                    <a href="{{route('menus')}}" class="btn btn-success"><i class="fa fa-users"></i>&ensp;View Menus</a>
                                </h2>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" name="menu" id="first-name"
                                                   class="form-control col-md-7 col-xs-12" value="{{old('menu')}}">
                                            <small class="text text-danger">{{$errors->first('menu')}}</small>
                                        </div>
                                    </div>
